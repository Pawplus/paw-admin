<script setup lang="ts">
  ...
  const subdistricts = ref(['Subdistrict 1', 'Subdistrict 2']) // replace with real data
  const districts = ref(['District 1', 'District 2']) // replace with real data
      ...
      <v-card>
        ...
        <v-card-text>
          <v-form>
            ...
            <v-select label="Kelurahan (autofill dari kelurahan)" :items="subdistricts" v-model="clinic.address.subdistrict" />
            <v-select label="Kecamatan (autofill dari kelurahan)" :items="districts" v-model="clinic.address.district" />
  
            <v-row>
              <v-col cols="8">
                <v-select label="Kota (autofill dari kelurahan)" :items="cities" v-model="clinic.address.city" />
              </v-col>
              <v-col cols="4">
