...
import type { AddClinic } from '~/types/dashboard';
import { useRouter } from 'vue-router';
import PopupModalAddClinic from './PopupModalAddClinic.vue';
...
<template>
    <v-container>
        ...
        <v-card>
            <v-card-text>
                <v-form>
                    ...
                    <v-select label="Kelurahan" :items="subdistricts" v-model="clinic.address.subdistrict" />
                    <v-select label="Kecamatan" :items="districts" v-model="clinic.address.district" />

                    <v-row>
                        <v-col cols="8">
                            <v-select label="Kota" :items="cities" v-model="clinic.address.city" />
                        </v-col>
                        <v-col cols="4">
        ...
        <PopupModalAddClinic v-model:isDialogOpen="isPopupOpen" :clinic="clinic" :files="files" />
    </v-container>
</template>
